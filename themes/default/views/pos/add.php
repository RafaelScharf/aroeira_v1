...
<head>
    <meta charset="utf-8">
    <title><?=lang('pos_module') . " | " . "Emporium";?></title>
    ...
    <script type="text/javascript" src="<?=$assets?>pos/js/handleEnter.js"></script>
...
<div id="wrapper">
    <header id="header" class="navbar m-3">
        <div class="container">
            <a class="navbar-brand" href="index.php/welcome"><span class="logo"><span class="pos-logo-lg"><?= $Settings->site_name?>    </span><span class="pos-logo-sm"><?=lang('pos')?></span></span></a>
            ...
            <div class="header-nav">
                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown">
                        <a class="btn blightOrange pos-tip" id="opened_bills" title="<span><?=lang('Manter pedido em aberto')?></span>" data-placement="bottom" data-html="true" href="<?=site_url('pos/opened_bills')?>" data-toggle="ajax">
                            <i class="fa fa-th"> Pedidos em aberto</i>
                        </a>
                    </li>
                    <li class="dropdown">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="payment_content">
                <div class="row">
                    ...
                    <div class="col-md-2 col-sm-3 text-center" style="display: none;">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i
                        class="fa fa-2x">&times;</i></button>
                <h4 class="modal-title" id="susModalLabel"><?=lang('Marcar na conta');?></h4>
            </div>
            <div class="modal-body">
                <p><?=lang('Insira a referência para a venda fiado.<br><small>Ex: Nome Fulano - (45)99999-9999</small>');?></p>

                <div class="form-group">
                    <?=lang("Nome e/ou Telefone do cliente.", "reference_note");?>
...
<script type="text/javascript">
var site = <?=json_encode(array('base_url' => base_url("index.php"), 
            'settings' => $Settings, 'dateFormats' => $dateFormats))?>, 
...
<?php if ($this->input->get('customer')) {?>
        if (!localStorage.getItem('positems')) {
            //Se não tiver no storage ele atribui o item ao storage
            localStorage.setItem('poscustomer', <?=$this->input->get('customer');?>);
        } else if (!localStorage.getItem('poscustomer')) {
            //Se não tiver no storage ele atribui o customer ao storage
        ...
        $('#poscustomer').val(localStorage.getItem('poscustomer')).select2({
            ...
            ajax: {
                ...
                error: function(error) {
                    console.log("Falha no resultado do ajax.");
                }
            }
        });
