...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-info-circle"></i><?= lang('tickets'); ?></h2>

        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown"><a style="padding: 10px;" href="<?= site_url('support/open_ticket'); ?>" data-toggle="modal"
                                        data-target="#myModal"><i class="icon fa fa-plus"></i>Abrir Chamado</a></li>
            </ul>
        </div>
    </div>
