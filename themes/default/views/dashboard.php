                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <ul id="dbTab" class="nav nav-tabs">
                            ...
                            <li class="" style="display: none;"><a href="#quotes"><?= lang('quotes') ?></a></li>
                            <?php } if ($Owner || $Admin || $GP['purchases-index']) { ?>
                            <li class=""><a href="#purchases"><?= lang('purchases') ?></a></li>
                            <?php } if ($Owner || $Admin || $GP['transfers-index']) { ?>
                            <li class="" style="display: none;><a href="#transfers"><?= lang('transfers') ?></a></li>
...
<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title h3" id="gridSystemModalLabel">Aviso de atualização!</h4>
        </div>
        <div class="modal-body">
            <p>Boas novas! O sistema foi atualizado, veja os novos recusos:
            </p>
            <ul>
            <li style="margin-left: 3%;"><strong>Pedido em aberto ou Marcar na conta:</strong><p>Agora você poderá deixar um pedido EM ABERTO, ou melhor dizendo, Marcar na conta. <br><a href="https://drive.google.com/file/d/1vpRVzyjrbMFKT2XQ998DAaKfHt9qEuF5/view" target="_blank">Clique aqui e veja o vídeo tutorial</a></p></li>
            <li style="margin-left: 3%;"><strong>Valor pago agora é igual ao  Valor Total automaticamente:</strong><p>Agora se a venda não precisar de troco, VOCÊ não irá tem que inserir nenhum VALOR<br><a href="https://drive.google.com/file/d/1mZkXXyv7tKntR0j47W8WcsubNtYnmTrZ/view" target="_blank">Clique aqui e veja o vídeo tutorial</a></p></li>
